package net.eadtrust.web;

import javax.servlet.ServletContext;
import javax.servlet.ServletException;
import javax.servlet.ServletRegistration;

import net.eadtrust.web.config.WebMvcContextConfiguration;
 ...
 * 
 */
public class NoticemanWebApplicationInitializer implements WebApplicationInitializer {
    ...
    private void registerDispatcherServlet(ServletContext servletContext) {
        ...
        dispatcher = servletContext.addServlet(DISPATCHER_SERVLET_NAME, dispatcherServlet);
