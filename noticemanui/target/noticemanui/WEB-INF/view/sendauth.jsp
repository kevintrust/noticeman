...
<head>
<title>Enviar correo electrónico certificado con autenticación simple</title>
  ...
  AnyTime.picker( "field1",
	...
	<script type="text/javascript" >
		tinyMCE.init({
	        ...
	        theme_advanced_buttons1 : "fontsizeselect,bold,italic,underline,link,unlink,separator,undo,redo",
...
<article>
	...
	<h1>Notificación con autenticación simple</h1>
	<section>
	...
	<form action="sendauthresp" method="post" accept-charset="utf-8" name="formtst" id="form" enctype="multipart/form-data">
		<br />	
		<h3>Notificación</h3>
