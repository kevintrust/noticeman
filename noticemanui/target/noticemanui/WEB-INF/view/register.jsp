...
<head>
<title>Registrar cuenta para envíos</title>
...
<article id="main">
	...
	<form action="registerresp" method="post" accept-charset="utf-8" name="formtst" id="login" enctype="multipart/form-data">	
	<h1>¡Demo  <strong>Noticeman</strong>!</h1>
	
	<p>Registre una cuenta de correo</p>
	...
	<h2>Formulario de registro</h2>
	    ...
	    <div class="field">
    	<label for="mail">Dirección de correo:</label>    	<input type="text" name="mail" value="" id="email" maxlength="80" size="30"  />    	<span class="error_form"></span>
    </div>
    <div class="field">
    	<label for="name">Nombre y apellidos:</label>    	<input type="text" name="name" value="" id="name" maxlength="20" size="30"  />		<span class="error_form"></span>
    </div>
