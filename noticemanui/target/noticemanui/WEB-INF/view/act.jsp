...
<article id="main">
	...
	<form action="actresp" method="post" accept-charset="utf-8" name="formtst" id="login" enctype="multipart/form-data">	
	<h1>¡Demo  <strong>Noticeman</strong>!</h1>
	
	<p>Introduzca el CSV de la notificación.</p>
	...
	<h2>Acta</h2>
	    ...
	    <div class="field">
    	<label for="code">CSV :</label>    	<input type="text" name="code" value="" id="code" maxlength="80" size="30"  />    	<span class="error_form"></span>
    </div>
				
    <div class="submit"> 
        <button type="submit">Recuperar acta</button>     
    </div>
